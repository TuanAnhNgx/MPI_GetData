            ...
            try
            {
                for (i = 1; i <= 10; i++)
                {
                    ...
                    else
                    {
                        if (i >= 10)
                        {
                            //Nếu main_Xpath ấn đến lần thứ 10 thì sẽ next trang.
                            j++;
                            if (j == pageNumber + 1)
                            {
                                j = 1;
                            ...
                            i = 1;
                            string nextPage_Xpath = "//*[@id=\"search-home\"]/div[3]/div[2]/div/div/ul/li[" + j + "]";
                            IWebElement nextpage = driver.FindElement(By.XPath(nextPage_Xpath));
                            nextpage.Click();
                            Thread.Sleep(7000);
                        }
                        ...
                        matbmtCheck = matbmtCheck.Substring("Mã TBMT: ".Length, "IB2300108379".Length);
...
void reWork()
        ...
        void getData1()
        {
            ...
            SqlConnection conn = new SqlConnection(conStr.conStr);
            string check = "";
            ...
            try
            {
                ...
                if (check == "Chủ đầu tư")
                {
                    ...
                    qrTemp = "INSERT INTO TBMT_Temp VALUES(N'" + maTBMT + "', '" + ngayDangTai + "',N'" + phienBanThayDoi + "',N'" + maKHLCNT + "', N'" + PhanLoaiKHLCNT + "',N'" + TenDuToanMuaSam + "',N'" + TenGoiThau + "',N'" + ChuDauTu + "',N'" + BenMoiThau + "',N'" + NguonVon + "',N'" + LinhVuc + "',N'" + HinhThucLuaChonNhaThau + "',N'" + LoaiHopDong + "',N'" + TrongNuocQuocTe + "',N'" + PhuongThucLuaChonNhaThau + "',N'" + ThoiGianThucHienHD + "',N'" + HinhThucDuThau + "',N'" + DiaDiemPhatHanhEHSMT + "',N'" + ChiPhiNopEHSDT + "',N'" + DiaDiemNhanEHSDT + "',N'" + DiaDiemThucHienGoiThau + "','" + ThoiDiemDongThau + "','" + ThoiDiemMoThau + "',N'" + DiaDiemMoThau + "',N'" + HieuLucBaoGia + "', N'" + SoQuyetDinhPheDuyet + "','" + NgayPheDuyet + "', N'" + CoQuanBanHanhQuyetDinh + "', N'" + QuyetDinhPheDuyet + "')";
                ...
                SqlCommand cmdTemp = new SqlCommand(qrTemp, conn);
                cmd.ExecuteNonQuery();
            ...
            catch (Exception ex)
            {
                ...
                string errLog = "INSERT INTO errorLog VALUES('" + maTBMT + "', N'" + ex + "', '" + sysDate + "')";
                conn.Open();
                SqlCommand cmdErr = new SqlCommand(errLog, conn);
